...
android {
    namespace = "com.huetechcoop.nftsam"
    ...
    defaultConfig {
        ...
        applicationId = "com.huetechcoop.nftsam"
...
dependencies {
    // Nếu bạn dùng Firebase Messaging
    implementation("com.google.firebase:firebase-messaging:23.4.0")

    // Nếu bạn dùng flutter_local_notifications
...
configurations.all {
    resolutionStrategy {
        ...
        // Thêm 3 dòng này để trị dứt điểm lỗi mới:
